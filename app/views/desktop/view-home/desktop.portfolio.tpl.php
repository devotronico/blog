<div id="portfolio">
    <div id="portfolio-title"><p>Projects</p></div>
    <div id="portfolio-container">
        <div class="portfolio-box">
            <div class="portfolio-head">Meteo</div>
        ...
        <div class="portfolio-box">
            ...
            <p class="portfolio-text">Un videogame che mescola uno stile grafico 8bit con un gameplay moderno</p>
            <a class="portfolio-btn" href="/home/download">Scarica</a>
        </div>
        <div class="portfolio-box">
            <div class="portfolio-head">Android App</div>
            <div class="portfolio-icon">
        ...
        <div class="portfolio-box">
            ...
            <p class="portfolio-text">Esempio di sito internet con negozio online creato con Wordpress e WooCommerce</p>
