...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-125021474-1"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-125021474-1');
</script>
<!-- chiude Global site tag (gtag.js) - Google Analytics -->
...
<meta name="theme-color" content="#ffffff">
  ...
  <body>
    ...
    <script src="/js/<?=$this->device?>/<?=$this->script?>.js"></script> 
  </body>
</html>