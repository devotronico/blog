...
let containerOffsetTop = document.querySelectorAll(".debug__wrapper-offsetTop"); // debug__wrapper-offsetTop
...
function debug(listOffSetTop, heightTrigger, num=0){
    ...
    listOffSetUp.style.top = (listOffSetTop[num] + heightTrigger)+'px';  // DEBUG/TEST
